# 🪙 IL SANGUE ROSSO — Site du groupe
...
1. Va sur https://console.firebase.google.com → **Ajouter un projet** (ex: `il-sangue-rosso`).
...
├── img/background.png   ← Sceau du Il Sangue Rosso (fond du site)
├── js/
...
```bash
cd chemin/vers/il-sangue-rosso-site
git init
git add .
git commit -m "Init Il Sangue Rosso"
git branch -M main
git remote add origin https://github.com/TON_COMPTE/il-sangue-rosso-site.git
